...
The internal M7j checkpoint now schedules the implemented direct-CSV and OGC
API Features paths in one deterministic global order. They share explicit
...
reported as truncation and are not followed. This remains tested infrastructure
